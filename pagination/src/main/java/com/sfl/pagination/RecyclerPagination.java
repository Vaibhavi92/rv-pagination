...
public final class RecyclerPagination extends Pagination {
    ...
    RecyclerPagination(RecyclerView recyclerView,
    ...
    public static class Builder {
        ...
        public Builder(RecyclerView recyclerView, Pagination.Callbacks callbacks) {
            this.recyclerView = recyclerView;
            this.callbacks = callbacks;
        }
         ...
         * internal adapter that will add loading row as the last item in the list. Pagination will observer the
        ...
        public Pagination build() {
            ...
            return new RecyclerPagination(recyclerView, callbacks, loadingTriggerThreshold, addLoadingListItem,
