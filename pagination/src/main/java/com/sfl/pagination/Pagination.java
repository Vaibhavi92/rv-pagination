...
public abstract class Pagination {
    ...
    /**
     * Call unbind to detach list (RecyclerView or AbsListView) from Pagination when pagination functionality is no
     * longer needed on the list.
     * <p/>
     * Pagination is using scroll listeners and adapter data observers in order to perform required checks. It wraps
     ...
     */
    public static RecyclerPagination.Builder with(RecyclerView recyclerView, Callbacks callback) {
        return new RecyclerPagination.Builder(recyclerView, callback);
    }
